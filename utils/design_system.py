...
<style>
    ...
    /* ── Hide Streamlit header bar and toolbar ───────────────────── */
    /* The white header bar overlaps the page title — hide it entirely */
    ...
    /* Extra top padding so the h1 title is never clipped by the header */
    .block-container {{
    ...
    /* Label: same uppercase 11px compact style as selectbox labels */
    ...
    [data-testid="stSegmentedControl"] [role="group"] {{
        ...
        border: 0.5px solid rgba(27,42,74,0.15) !important;
        min-height: 30px !important;
        height: 30px !important;
        align-items: center !important;
        box-sizing: border-box !important;
    }}
    /* Unselected pill: white bg, subtle navy border */
    ...
    /* Selected pill: orange bg, navy text, no border */
